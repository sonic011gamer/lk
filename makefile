...
CFLAGS := -O2 -g -fno-builtin -finline -W -Wall -Wno-unused-variable -Wno-implicit-fallthrough -Wno-pointer-sign -Wno-switch-unreachable -Wno-missing-field-initializers -Wno-multichar -Wno-unused-parameter -Wno-unused-function -Wno-shift-negative-value -Wno-misleading-indentation -Wno-unused-const-variable -include $(CONFIGHEADER)
#CFLAGS += -Werror
ifeq ($(EMMC_BOOT),1)
