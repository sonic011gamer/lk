...
TAGS_ADDR        := BASE_ADDR+0x00000100 # 0x01e00000
KERNEL_ADDR      := BASE_ADDR+0x00008000 # boots in 0x00008000
RAMDISK_ADDR     := BASE_ADDR+0x01000000 # 0x02000000
#SCRATCH_ADDR     := 0x0E000000
SCRATCH_ADDR     := 0x10000000
SCRATCH_SIZE     := 0x20000000

UEFI_FB_BASE := 0x20400000 # 0x00400000
